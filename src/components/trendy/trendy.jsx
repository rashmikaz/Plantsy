  ...
  return (
    <div>
      <div className="absolute top-260">
        <h1 className="relative bottom-40 left-120 text-6xl pb-10">
          Our Trendy plants
        </h1>
        <div className="glass-card-1">
          <div className="flex flex-col items-center text-center space-y-4">
            <img
              src="src/assets/trendy-01.png"
              alt=""
              className="relative right-95 bottom-35"
            />
            <div>
              <h1 className="text-4xl relative bottom-120 left-35">
                For Small Decs Ai Plat
              </h1>
              <p className="w-140 relative bottom-115 left-60 text-left">
      ...
      <div className="absolute top-410">
        <div className="glass-card-1">
          <div className="flex flex-col items-center text-center space-y-4">
            <img
              src="src/assets/trendy-02.png"
              alt=""
              className="relative left-90 bottom-35"
            />
